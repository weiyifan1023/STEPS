...
if [ "$OUTPUT" == "" ]; then
    OUTPUT=/share/project/weiyifan/KG_RAG/results/qwen_ckpt/random2_IT_Qwen2-7B
fi
if [ "$ZERO_STAGE" == "" ]; then
    ZERO_STAGE=3
fi
...
deepspeed  main2.py \
    ...
    --model_name_or_path /share/project/weiyifan/KG_RAG/results/qwen_ckpt/random1_KI_Qwen2-7B/epoch-2-669 \
