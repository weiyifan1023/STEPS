...
if [ "$OUTPUT" == "" ]; then
#    OUTPUT=/share/project/weiyifan/KG_RAG/results/ckpt_cg/ours/Qwen2.5-7B-Instruct
    OUTPUT=/share/project/weiyifan/KG_RAG/results/ckpt_cg/skillmix/Qwen2.5-7B-Instruct_alpaca52k
fi
if [ "$ZERO_STAGE" == "" ]; then
    ZERO_STAGE=3
fi
