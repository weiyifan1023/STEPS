...
if [ "$OUTPUT" == "" ]; then
#    OUTPUT=/share/project/weiyifan/KG_RAG/results/ckpt_cg/skillmix/Mistral-7B-v0.3
#    OUTPUT=/share/project/weiyifan/KG_RAG/results/ckpt_cg/skillmix/Mistral-7B-v0.3_alpaca52k
    OUTPUT=/share/project/weiyifan/KG_RAG/results/ckpt_cg/ours/Mistral-7B-v0.3
fi
if [ "$ZERO_STAGE" == "" ]; then
    ZERO_STAGE=3
fi
...
deepspeed  main2.py \
    ...
    --data_path $DataPath \
    --model_name_or_path /share/project/models/Mistral-7B-v0.3 \
